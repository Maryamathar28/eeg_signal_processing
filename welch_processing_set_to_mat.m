...
myFolder = 'C:\Users\abc\Desktop\Maryam\qEEG Conducted\POST\SET FILES\';
...
for i = 1:length (Files_dir);
    ...
    for j=1:14;
%         name.data;
        [post_power(j,:),f] = pwelch(name.data(j,:),windowLength,noverlap,nfft,fs);
        p(i,j,:) = post_power(j,:);
        delta = find(f>=0 & f<4);
        theta = find(f>=4 & f<8);
        alpha = find(f>=8 & f<12);
...
POST.p = p_new;
POST.freq = f;
POST.meanallchan = meanallchan;
POST.relativepower = relativepower;
POST.rp_delta = rp_delta;
POST.rp_theta = rp_theta;
POST.rp_alpha = rp_alpha;
POST.rp_lower_alpha = rp_lower_alpha;
POST.rp_upper_alpha = rp_upper_alpha;
POST.rp_beta = rp_beta;
POST.rp_lower_beta = rp_lower_beta;
POST.rp_mid_beta = rp_mid_beta;
POST.rp_upper_beta = rp_upper_beta;
POST.rp_gamma = rp_gamma;
POST.rp_delta_mean = rp_delta_mean;
POST.rp_theta_mean = rp_theta_mean;
POST.rp_alpha_mean = rp_alpha_mean;
POST.rp_lower_alpha_mean = rp_lower_alpha_mean;
POST.rp_upper_alpha_mean = rp_upper_alpha_mean;
POST.rp_beta_mean = rp_beta_mean;
POST.rp_lower_beta_mean = rp_lower_beta_mean;
POST.rp_mid_beta_mean = rp_mid_beta_mean;
POST.rp_upper_beta_mean = rp_upper_beta_mean;
POST.rp_gamma_mean = rp_gamma_mean;
POST.rp_delta_mean_all_subj = rp_delta_mean_all_subj;
POST.rp_theta_mean_all_subj = rp_theta_mean_all_subj;
POST.rp_alpha_mean_all_subj = rp_alpha_mean_all_subj;
POST.rp_lower_alpha_mean_all_subj = rp_lower_alpha_mean_all_subj;
POST.rp_upper_alpha_mean_all_subj = rp_upper_alpha_mean_all_subj;
POST.rp_beta_mean_all_subj = rp_beta_mean_all_subj;
POST.rp_lower_beta_mean_all_subj = rp_lower_beta_mean_all_subj;
POST.rp_mid_beta_mean_all_subj = rp_mid_beta_mean_all_subj;
POST.rp_upper_beta_mean_all_subj = rp_upper_beta_mean_all_subj;
POST.rp_gamma_mean_all_subj = rp_gamma_mean_all_subj;
...
save('C:\Users\abc\Desktop\Maryam\qEEG Conducted\POST\SET FILES', 'POST')
